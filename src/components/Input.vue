...
export default {
  ...
  methods: {
    ...
    renderInputContainer() {
      ...
      return (
        h('div', { class: 'vue-customtreeselect__input-container', ...props }, children)
      );
    },
    ...
    renderInput() {
      ...
      return (
        h('input', {
          ref: 'input',
          class: 'vue-customtreeselect__input',
          type: 'text',
          autocomplete: 'off',
          tabIndex: instance.tabIndex,
    ...
    renderSizer() {
      return (
        h('div', { ref: 'sizer', class: 'vue-customtreeselect__sizer' }, [this.value])
      );
    },
