...
export default {
  ...
  methods: {
    renderX() {
      ...
      return (
        h('div', { class: 'vue-customtreeselect__x-container', title, onMousedown: this.handleMouseDownOnX }, [
          h(DeleteIcon, { class: 'vue-customtreeselect__x' }),
        ])
      );
    },
    ...
    renderArrow() {
      const { instance } = this;
      const arrowClass = {
        'vue-customtreeselect__control-arrow': true,
        'vue-customtreeselect__control-arrow--rotated': instance.menu.isOpen,
      };

      if (!this.shouldShowArrow) return null;

      return (
        h('div', { class: 'vue-customtreeselect__control-arrow-container', onMousedown: this.handleMouseDownOnArrow }, [
    ...
    renderValueContainer(children) {
      return (
        h('div', { class: 'vue-customtreeselect__value-container' }, [
          children,
        ])
      );
    },
  ...
  render() {
    ...
    return (
      h('div', { class: 'vue-customtreeselect__control', onMousedown: instance.handleMouseDown }, [
