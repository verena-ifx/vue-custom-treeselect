...
export default {
  provide() {
    return {
      // Enable access to the instance of root component of vue-customtreeselect
      // across hierarchy.
      instance: this,
    };
  },
  ...
  props: {
    ...
    */
     ...
     * enough space, vue-customtreeselect will automatically flip the menu.
    ...
    setCurrentHighlightedOption(node, scroll = true) {
      ...
      if (this.menu.isOpen && scroll) {
        const scrollToOption = () => {
          ...
          const $option = $menu.querySelector(`.vue-customtreeselect__option[data-id="${node.id}"]`);
